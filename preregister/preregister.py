...
class preregistermainform(forms.ModelForm):
	...
	class Meta:
		...
		fields = ('first_name', 'last_name', 'email', 'phone', 'address', 'city', 'state', 'zip_code', 'loan_amount', 'payment_date', 'bank_name', 'since_how_long_banking', 'online_banking_status', 'current_balance_in_account')
